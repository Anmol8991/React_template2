...
import clientLogo from "@/assets/images/demo/starlogo.png";
import sophiaLogo from "@/assets/images/demo/sophiaVerse4.jpg";
import avatar1 from "@/assets/images/users/avatar-1.jpg";
import { EditProfileForm } from "@/components/utilities/twin/Profile/EditProfileForm";
import Avatar from "@/components/utilities/twin/Profile/Avatar";
...
const ProfilePage = () => {
  ...
  const [userEarned, setEarnedPoints] = useState(0);
                ...
                <Row className="g-4 mt-2">
                  ...
                  <Col>
                    <div className="p-2">
                      ...
                      <div className="hstack text-white gap-1 align-items-start">
                        <div className="me-2">
                  ...
                  <Col xs={12} className="col-lg-5 order-last order-lg-0">
                    <Row className="text text-white text-center">
                      <Col lg={4} xs={4}>
                        <div className="p-2">
                          <h4 className="text-white mb-1">{userEarned.toFixed(2)}</h4>
                    ...
                    <Row className="text text-dark text-center">
                      ...
                      <Col lg={3} xs={12}>
                        <Card className="card-animate ">
                          <div className="p-2">
                            <h4 className=" mb-2 fs-20">Starbucks</h4>
                            <div className="fs-14 mb-0">
                              ...
                              <Row className="align-items-center py-1">
                                ...
                                <Col className="col-6">
                                  <span className="d-flex align-items-end justify-content-between">
                                    Brand
                                  </span>
                                </Col>
                              </Row>
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <span style={{ marginLeft: "1rem" }}>
                                        {userWalletId.slice(0,4)}...{userWalletId.slice(-4)}
                                      </span>
                                    </div>
                                  </div>
                                </Col>
                                  ...
                                  >
                                    <span className="logo-sm">
                                      <img
                                        src={twinLogo}
                                        alt=""
                                        className="avatar-title rounded-circle  bg-white avatar-xs shadow"
                                      />
                                    </span>
                                  </div>
                                </Col>
