    ...
    fetchClientInfo(
      ...
      .then(({ success, data: response, message }) => {
        if (success) {
          ...
          const columnsData = [
            {
              name: html("<center>Protocol Info</center>"),
              key: "protocolInfo",
              id: "protocolInfo",
              formatter: (info) =>
                _(
                  <span className="d-flex align-items-center">
                    <img
                      ...
                      src={info.protocolLogo}
                    />
                    <span>{info.protocolName}</span>
                  </span>
                ),
              sort: {
                compare: (a, b) => {
            ...
            },
            {
              ...
              formatter: (clientInfo, entries) => {
                const clientId = entries?._cells[1].data.clientId;
                const clientName = entries?._cells[1].data.client;
                return _(
                  <center>
                    <UncontrolledDropdown>
                      <DropdownToggle
      ...
      <div className="position-relative pt-3">
        <div className="table-filters end-0 d-flex" style={{ zIndex: 100 }}>
          ...
          <div className="d-flex gap-2">
                  ...
                  <CSVLink
                    {...{
                      data: clientsData?.map((data) => ({
                        ...data,
                        protocolInfo: data.protocolInfo.protocolName,
            ...
            <UncontrolledDropdown className="">
              <DropdownToggle
                className=" btn btn-soft-success border btn-sm px-1"
        ...
        {loading ? (
          ...
          <Grid
            ...
            search={{
              selector: (cell) =>
                cell?.protocolName || cell?.client || cell?.value || cell,
            }}
            pagination={false}
            sort={true}
            style={{
